  ...
  return function (e) {
    ...
    var r = n(8), i = n(3), o = n(23), s = function (e, t) {
      ...
      if (!e) try {
        ...
        var f = new o({name: "CompileError", path: n, message: "template not found: " + v.message, stack: v.stack});
        if (t.bail) throw f;
        return s(f, t)
      }
    ...
    var i = n(0), o = n(12), s = n(13), a = n(14), u = n(15), c = n(16), l = n(17), f = n(18), p = n(19), h = n(20),
      m = n(22), v = {
        source: null,
        filename: null,
        rules: [p, f],
      ...
      v = "$$out", d = "$$line", g = "$$blocks", y = "$$slice", b = "$$from", x = "$$options", w = function (e, t) {
        ...
        return s(e, [{
          ...
          key: "importContext", value: function (e) {
            ...
            w(f, e) || -1 !== o.indexOf(e) || (w(r, e) ? (n = r[e], w(i, e) && i[e].forEach(function (e) {
              return t.importContext(e)
            })) : n = "$escape" === e || "$each" === e || w(u, e) ? l + "." + e : c + "." + e, f[e] = n, s.push({
              name: e,
              value: n
            }))
          }
          ...
          key: "build", value: function () {
            var e = this.options, t = this.context, n = this.scripts, r = this.stacks, i = this.source, o = e.filename,
              s = e.imports, a = [], f = w(this.CONTEXT_MAP, h), m = 0, y = function (e, t) {
            ...
            r.push("function(" + c + "){"), r.push("'use strict'"), r.push(c + "=" + c + "||{}"), r.push("var " + t.map(function (e) {
              ...
              e.tplToken.type === u.TYPE_EXPRESSION && r.push(d + "=[" + [e.tplToken.line, e.tplToken.start].join(",") + "]"), a.push(y(e.code, e.tplToken)), r.push(E(e.code))
            }), r.push("}catch(error){"), r.push("throw {" + ["name:'RuntimeError'", "path:" + k(o), "message:error.message", "line:" + d + "[0]+1", "column:" + d + "[1]+1", "source:" + k(i), "stack:error.stack"].join(",") + "}"), r.push("}")) : n.forEach(function (e) {
              a.push(y(e.code, e.tplToken)), r.push(E(e.code))
            }), f && (r.push(v + "=''"), r.push(p + "(" + b + "," + c + "," + g + ")")), r.push("return " + v), r.push("}");
            var T = r.join("\n");
            try {
              ...
              for (var j = 0, $ = 0, _ = 0, S = void 0; j < n.length;) {
                ...
                if (!this.checkExpression(C.code)) {
                  $ = C.tplToken.line, _ = C.tplToken.start, S = C.code;
                  break
                }
                j++
              }
    ...
    var i = n(0), o = function (e, t) {
      if (i) {
        var o, s = n(21).minify, a = t.htmlMinifierOptions, u = t.rules.map(function (e) {
          return e.test
        });
